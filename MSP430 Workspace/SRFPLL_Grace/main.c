//***************************************************************************************
//  MSP430G2553: SRF PLL Design and Optimization
//
//  Sambhav R Jain
...
//    	TA1CCR1 = (vq+325.2691)*1.57254399;		// P2.1
    	...
    	TA1CCR1 = (vq+325.2691)*1.5725;		// P2.1

    	// theta*1023/(2*pi)
		TA1CCR2 = theta*162.8155;				// P2.4

//    	TA0CCR1 = vgrid[0]; // v_a (A2) phase at P2.6
//    	TA1CCR1 = vgrid[1]; // v_b (A1) phase at P2.1
...
//		TA1CCR1 = o/p_2 (Pin 2.1)
//		TA1CCR2 = o/p_3 (Pin 2.4)
